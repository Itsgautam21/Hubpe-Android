...
@HiltViewModel
class LocationViewModel @Inject constructor(private val placesUseCase: MapPlacesUseCase) : ViewModel() {
    ...
    fun getCameraPosition(placesResult: PlacesResult, result: (cameraPos: CameraPosition?) -> Unit) {
